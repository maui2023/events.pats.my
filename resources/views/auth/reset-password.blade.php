        ...
        <div class="rounded-xl border bg-white p-6 shadow-sm">
            <form method="POST" action="{{ route('password.update') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email', $email) }}" required class="w-full border rounded px-3 py-2" />
                </div>
                <div>
                    <label class="block text-sm mb-1">Kata Laluan Baru</label>
                    <input type="password" name="password" required class="w-full border rounded px-3 py-2" />
                </div>
                <div>
                    <label class="block text-sm mb-1">Sahkan Kata Laluan</label>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <button type="submit" class="px-4 py-2 bg-slate-900 text-white rounded">Reset</button>
                </div>
            </form>
        </div>
    </div>
